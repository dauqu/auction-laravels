    ...
    <div class="container">
        <div class="product-details-slider-top-wrapper">
            <div class="product-details-slider owl-theme owl-carousel" id="sync1">
                ...
                <!-- <div class="slide-top-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/product1.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-top-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/product2.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-top-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/product3.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-top-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/product4.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-top-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/product5.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-top-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/product6.png')}}" alt="product">
                    </div>
                </div> -->
            </div>
        </div>
        <div class="product-details-slider-wrapper">
            <div class="product-bottom-slider owl-theme owl-carousel" id="sync2">
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/01.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/02.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/03.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/04.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/05.png')}}" alt="product">
                    </div>
                </div>
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{ asset('/assets/images/product/06.png')}}" alt="product">
                    </div>
                </div>
            </div>
                ...
                <div class="product-details-content">
                    ...
                    <ul class="price-table mb-30">
                        <li class="header">
                            ...
                            <h3 class="price">INR ₹{{ $product->price }}</h3>
                        </li>
                        <li>
