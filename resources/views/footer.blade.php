                ...
                <div class="newslater-area">
                    ...
                    <div class="newslater-content">
                        <div class="section-header left-style mb-low">
                            <h5 class="cate">Subscribe to Yashti</h5>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="6a020f061a2a0f040d051e020f070f44090507">[email&#160;protected]</span></a>
                                </li>
                                <li>
            ...
            <div class="container">
                <div class="copyright-area">
                    <div class="footer-bottom-wrapper">
                        <div class="logo">
                            <a href="home"><img src="{{ asset('/assets/images/logo/logo.png')}}" alt="logo"></a>
                        </div>
                        ...
                        <div class="copyright">
                            <p>&copy; Copyright 2021 | <a href="#0">Yashti</p>
                        </div>
                    </div>
                </div>
            </div>
